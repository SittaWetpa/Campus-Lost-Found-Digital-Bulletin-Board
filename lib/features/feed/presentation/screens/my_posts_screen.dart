              ...
              children: [
                ...
                Expanded(
                  child: itemsAsync.when(
                    ...
                    data: (_) => list.isEmpty
                        ? _EmptyState(
                            title: _activeTab ? 'No active posts' : 'No resolved posts',
                            body: _activeTab
        ...
        child: AnimatedContainer(
          ...
          child: Text(
            ...
            style: TextStyle(
              ...
              color: selected ? _kInk900 : _kInk500,
            ),
          ),
        ),
      ),
...
// ── My Post card — mirrors ItemCard style with inline status badge ────────────
...
class _CategoryChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _Chip(
      ...
      bg: isFounder ? const Color(0xFFDCFCE7) : const Color(0xFFFFE4E6),
      fg: isFounder ? const Color(0xFF16A34A) : const Color(0xFFE11D48),
    );
  }
}
...
class _StatusChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final (label, bg, fg) = switch (status) {
      ...
      ItemStatus.resolved =>
        ('RESOLVED', const Color(0xFFFEF3C7), const Color(0xFFD97706)),
      ItemStatus.expired =>
        ('EXPIRED', const Color(0xFFF3F4F6), const Color(0xFF6B7280)),
    };
      ...
      child: Column(
        ...
        children: [
          Icon(Icons.inbox_outlined,
              size: 64, color: _kInk500.withValues(alpha: 0.4)),
