...
// CancelRequestUseCase unit tests
...
void main() {
  ...
  late CancelRequestUseCase useCase;

  setUp(() {
    repository = _MockItemRequestRepository();
    useCase = CancelRequestUseCase(repository);
    when(
  ...
  test(
    'WBS 1.3 — cancelRequest() is called exactly once with correct params',
    () async {
