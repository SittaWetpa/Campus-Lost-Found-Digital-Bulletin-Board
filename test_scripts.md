...
| 3.1 | M3 — App launches on Android device/emulator (`flutter run -d <android>`) | Manual on emulator-5554 | Manual | ✅ release build launched on emulator-5554; Crashlytics fatal-crash verified end-to-end in Firebase console (2026-05-31) |
